...
//FileName: system_gd32f3x0.c
//Brief:CMSIS Cortex-M4 Device Peripheral Access Layer Source File for GD32F3x0 Device Series
...
static void system_clock_72m_hxtal(void)
{
    ...
    // HXTAL is stable // AHB = SYSCLK 

    RCU_CFG0 |= RCU_AHB_CKSYS_DIV1;

    RCU_CFG2 |= RCU_USART0SRC_CKSYS;
    ...
    // MLI for 12 MHZ  HXTAL  RCU_CFG0 |= RCU_PLL_PREDV6; RCU_CFG0 |= RCU_PLL_MUL9
...
static void system_clock_96m_hxtal(void)
{
    ...
    RCU_CFG0 &= ~(RCU_CFG0_PLLSEL | RCU_CFG0_PLLMF | RCU_CFG0_PLLMF4 | RCU_CFG0_PLLDV);
    RCU_CFG1 &= ~(RCU_CFG1_PLLPRESEL | RCU_CFG1_PLLMF5);
    RCU_CFG1 |= RCU_PLL_PREDV3;   // MLI for 12 MHZ  HXTAL  RCU_CFG1 |= RCU_PLL_PREDV3; 8MHZï¼šRCU_CFG1 |= RCU_PLL_PREDV2
...
static void system_clock_168m_hxtal(void)
{
    ...
    // PLL = HXTAL /2 * 28 = 168 MHz 
    RCU_CFG0 &= ~(RCU_CFG0_PLLSEL | RCU_CFG0_PLLMF | RCU_CFG0_PLLMF4 | RCU_CFG0_PLLDV);
    RCU_CFG1 &= ~(RCU_CFG1_PLLPRESEL | RCU_CFG1_PLLMF5);
    RCU_CFG1 |= RCU_PLL_PREDV2;   // MLI for 12 MHZ  HXTAL  RCU_CFG1 |= RCU_PLL_PREDV3; 8MHZï¼šRCU_CFG1 |= RCU_PLL_PREDV2
    RCU_CFG0 |= (RCU_CFG0_PLLSEL | RCU_PLL_MUL28); 
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//    \brief      configure the system clock to 192M by PLL which selects HXTAL as its clock source
//    \param[in]  none
//    \param[out] none
//    \retval     none
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
static void system_clock_192m_hxtal(void)
{
    ...
    RCU_CFG1 &= ~(RCU_CFG1_PLLPRESEL | RCU_CFG1_PLLMF5);
    RCU_CFG1 |= RCU_PLL_PREDV2;   // MLI for 12 MHZ  HXTAL  RCU_CFG1 |= RCU_PLL_PREDV3; 8MHZï¼šRCU_CFG1 |= RCU_PLL_PREDV2
    RCU_CFG0 |= (RCU_CFG0_PLLSEL | RCU_PLL_MUL32); 
