...
typedef struct
{
    ...
    usb_hid_descriptor_hid_struct              hid1_vendor;
    usb_descriptor_endpoint_struct             hid1_in_endpoint;

	usb_descriptor_interface_struct            hid2_interface;
    usb_hid_descriptor_hid_struct              hid2_vendor;
    usb_descriptor_endpoint_struct             hid2_in_endpoint;
	usb_descriptor_endpoint_struct             hid2_out_endpoint;
