...
//FileName: gd32f3x0_fmc.c
//Brief: GD32 TIMERS functions
...
void timer_channel_output_config(uint32_t timer_periph, uint16_t channel, timer_oc_parameter_struct* ocpara)
{
    ...
    case TIMER_CH_1://configure TIMER_CH_1 
        //reset the CH1EN bit
    ...
    case TIMER_CH_2:// configure TIMER_CH_2
        // reset the CH2EN bit
    ...
    case TIMER_CH_3:// configure TIMER_CH_3
        // reset the CH3EN bit
...
void timer_channel_output_mode_config(uint32_t timer_periph, uint16_t channel, uint16_t ocmode)
{
	switch(channel)
	{
		case TIMER_CH_0:// configure TIMER_CH_0
...
void timer_input_capture_config(uint32_t timer_periph,uint16_t channel, timer_ic_parameter_struct* icpara)
{
    ...
    case TIMER_CH_0:// configure TIMER_CH_0 
        ...
        TIMER_CHCTL2(timer_periph) &= (~(uint32_t)TIMER_CHCTL2_CH0EN); // reset the CH0EN bit 
    ...
    case TIMER_CH_1:// configure TIMER_CH_1 
        ...
        TIMER_CHCTL2(timer_periph) &= (~(uint32_t)TIMER_CHCTL2_CH1EN);// reset the CH1EN bit
    ...
    case TIMER_CH_2:// configure TIMER_CH_2
        ...
        TIMER_CHCTL2(timer_periph) &= (~(uint32_t)TIMER_CHCTL2_CH2EN);// reset the CH2EN bit 
    ...
    case TIMER_CH_3:// configure TIMER_CH_3 
        ...
        TIMER_CHCTL2(timer_periph) &= (~(uint32_t)TIMER_CHCTL2_CH3EN);// reset the CH3EN bit
...
void timer_input_pwm_capture_config(uint32_t timer_periph, uint16_t channel, timer_ic_parameter_struct* icpwm)
{
    ...
    if(TIMER_IC_POLARITY_RISING == icpwm->icpolarity) // Set channel input polarity
		{
    ...
    if(TIMER_IC_SELECTION_DIRECTTI == icpwm->icselection)// Set channel input mode selection 
		{
